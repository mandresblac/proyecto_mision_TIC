                    ...
                    if option == 1:
                        ...
                        if contador == 0:
                            ...
                            if contador < 2:
                                ...
                                contador > 2
                                if ubicacion_actual == 1:
                                    informacion1=  {"actual":[coor[0][0], coor[0][1]],
                                                    "zonawifi1":[zonas_wifi[0][0] , zonas_wifi[0][1], zonas_wifi[0][2]],
                                                    "recorrido":[dt1[0][0], "auto", round(tiempo(dt1[0][0], 20.83), 0), "bicicleta", round(tiempo(dt1[0][0], 3.33), 0)]}
                                    print(informacion1)
                                    confirma= int(input("¿Está de acuerdo con la información a exportar? \nPresione 1 para confirmar, 0 para regresar al menú principal: "))
                                    if confirma == 1:
                                    ...
                                    informacion2=  {"actual":[coor[1][0], coor[1][1]],
                                                    "zonawifi1":[zonas_wifi[1][0] , zonas_wifi[1][1], zonas_wifi[1][2]],
                                                    "recorrido":[dt2[0][0], "auto", round(tiempo(dt2[0][0], 20.83), 0), "bicicleta", round(tiempo(dt2[0][0], 3.33), 0)]}
                                    print(informacion2)
                                    confirma= int(input("¿Está de acuerdo con la información a exportar? \nPresione 1 para confirmar, 0 para regresar al menú principal: "))
                                    if confirma == 1:
                                        print("Exportando archivo")
                                    ...
                                    ubicacion_actual == 3
                                    informacion3=  {"actual":[coor[2][0], coor[2][1]],
                                                    "zonawifi1":[zonas_wifi[2][0] , zonas_wifi[2][1], zonas_wifi[2][2]],
                                                    "recorrido":[dt3[0][0], "auto", round(tiempo(dt3[0][0], 20.83), 0), "bicicleta", round(tiempo(dt3[0][0], 3.33), 0)]}
                                    print(informacion3)
                                    confirma= int(input("¿Está de acuerdo con la información a exportar? \nPresione 1 para confirmar, 0 para regresar al menú principal: "))
                                    if confirma == 1:
                                        print("Exportando archivo")
                        ...
                        print(informacion1)
                        f.close()
                        salida =int(input("Datos de coordenadas para zonas wifi actualizados, \npresione 0 para regresar al menú principal: "))
                        if salida == 0:
                            continue
                        else:
                            exit()
                        time.sleep(3)#Retarda ejecucion programa
                        borra_pantalla()#Llamada a funcion para limpiar la pantalla
                        exit()
                    elif option == 6:
